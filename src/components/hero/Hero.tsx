 ...
 * frame crops the painting to the tree and the headline follows it.
 */
    ...
    <section className="hero page" aria-labelledby="hero-title">
      ...
      <div className="hero-canvas">
        ...
        <div className="hero-art">
          ...
          <Image src="/images/canvas.jpg" alt="" width={1672} height={941} priority fetchPriority="high" quality={55} sizes="(min-width: 820px) min(100vw, 153vh), 178vw" className="hero-painting" data-variant="dark" />
          <Image src="/images/canvas-light.jpg" alt="" width={1672} height={941} loading="lazy" quality={55} sizes="(min-width: 820px) min(100vw, 153vh), 178vw" className="hero-painting" data-variant="light" />
          <Image src="/images/tree-cutout.webp" alt={t("paintingAlt")} width={1672} height={941} priority fetchPriority="high" quality={70} sizes="(min-width: 820px) min(100vw, 153vh), 178vw" className="hero-cutout hero-tree" data-variant="dark" />
          <Image src="/images/tree-cutout-light.webp" alt={t("paintingAlt")} width={1672} height={941} loading="lazy" quality={70} sizes="(min-width: 820px) min(100vw, 153vh), 178vw" className="hero-cutout hero-tree" data-variant="light" />
